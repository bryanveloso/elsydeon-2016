...
module.exports = (robot) ->
  ...
  # This first quote is made mostly unique so it doesn't interfere with the
  # users DB. The reason this isn't a simple array and is instead an associative
  # array is because we want to preserve a quotes unique ID.
