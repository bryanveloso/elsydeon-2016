...
module.exports = (robot) ->
  ...
  robot.respond /(oh|office|officehours)$/i, (msg) ->
    msg.send "Welcome to Office Hours, a humble attempt at a interview/discussion show. Have questions for Bryan our our guest? Tweet it using the hashtag #ASOH."
