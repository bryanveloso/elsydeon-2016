...
module.exports = (robot) ->
  ...
  robot.respond /emotes$/i, (msg) ->
    msg.send "We've got 10 emotes! avalonOOPS [OOPS], avalonFOCUS [FOCUS], avalonAWK [AWK], avalonHAI [HAI], avalonSTAR [STAR], avalonNOPE [NOPE], avalonDESK [DESK], avalonPLS [PLS], avalonHUG [HUG], and avalonSEMI [SEMI]. They are all the creations of the amazing LadyAsher, [http://twitter.com/asherartistry]."
